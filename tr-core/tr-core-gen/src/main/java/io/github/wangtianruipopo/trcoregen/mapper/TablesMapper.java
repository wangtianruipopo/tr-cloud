...
public interface TablesMapper extends BaseMapper<Tables> {
    ...
    IPage<Tables> mysqlAllTables(Page<Tables> page, @Param("params") Map<String, Object> params, List<OrderByColumn> order);
    IPage<Tables> pgsqlAllTables(Page<Tables> page, @Param("params") Map<String, Object> params, List<OrderByColumn> order);
}
